...
function restore_ui() {
  ...
  document.getElementById("show_earnings_surprise").checked =
    show_earnings_surprise;
  ...
  else document.getElementById("theme_light").checked = true;
  ...
  document
    ...
    .forEach((checkbox) => checkbox.addEventListener("change", save_options));
  document
...
function save_options() {
  ...
  show_earnings_surprise = document.getElementById(
    "show_earnings_surprise"
  ).checked;
...
// show an element
const show = (element) => {
  if (element != null && element.style != null) element.style.display = "block";
};
